...
_DailyWord _$DailyWordFromJson(Map<String, dynamic> json) => _DailyWord(
...
Map<String, dynamic> _$DailyWordToJson(_DailyWord instance) =>
    <String, dynamic>{
      'day': instance.day,
      'date': instance.date,
...
_DailyWordNotification _$DailyWordNotificationFromJson(
...
Map<String, dynamic> _$DailyWordNotificationToJson(
  _DailyWordNotification instance,
) => <String, dynamic>{
