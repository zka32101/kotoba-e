...
_WordModel _$WordModelFromJson(Map<String, dynamic> json) => _WordModel(
  ...
  nuanceExplanations:
      (json['nuanceExplanations'] as Map<String, dynamic>?)?.map(
        (k, e) =>
            MapEntry(k, NuanceExplanation.fromJson(e as Map<String, dynamic>)),
      ) ??
      const {},
...
_NuanceExplanation _$NuanceExplanationFromJson(Map<String, dynamic> json) =>
    _NuanceExplanation(
...
Map<String, dynamic> _$NuanceExplanationToJson(_NuanceExplanation instance) =>
    <String, dynamic>{
