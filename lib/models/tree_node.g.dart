...
_TreeNode _$TreeNodeFromJson(Map<String, dynamic> json) => _TreeNode(
  ...
  childWordIds:
      (json['childWordIds'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  connectedKanji:
      (json['connectedKanji'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
);
...
_WordTree _$WordTreeFromJson(Map<String, dynamic> json) => _WordTree(
...
Map<String, dynamic> _$WordTreeToJson(_WordTree instance) => <String, dynamic>{
